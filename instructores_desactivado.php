...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
        		...
        		<button type='button' class="btn btn-success" onclick="instructores()">Instructores</button>
			</div>
			<h4><i class='glyphicon glyphicon-search'></i> Buscar Instructores eliminados</h4>
		</div>			
	...
	include("footer.php");
	?>
	<script type="text/javascript" src="js/instructores_eliminados.js"></script>
...
function exportar_pdf (){
    window.open("ajax/pdf_instructores_eliminados.php", "_blank");
  } 
</script>