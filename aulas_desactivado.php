...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<div class="panel-heading">
		    <div class="btn-group pull-right">
        		...
        		<button type='button' class="btn btn-success" onclick="aulas()">Aulas</button>
			</div>
	...
	include("footer.php");
	?>
	<script type="text/javascript" src="js/aulas_eliminadas.js"></script>
...
function exportar_pdf (){
    window.open("ajax/pdf_aulas_eliminadas.php", "_blank");
  } 
</script>