<?php
  ...
  use Spipu\Html2Pdf\Exception\ExceptionFormatter;
    ...
    $sql="SELECT * FROM  historial_invcon order by id_historial_invcon desc";
    $query = mysqli_query($con, $sql);

	$content = '<h2>HISTÓRICO DE INVENTARIO PARA CONVOCATORIAS</h2>';
    ...
    $content .= '
	  <table>
        ...
        $pdf = "pdf/"."historico-inventario-convocatorias-".date('dmYHis').".pdf";
