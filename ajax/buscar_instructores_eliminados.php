<?php
  ...
  $action = (isset($_REQUEST['action'])&& $_REQUEST['action'] !=NULL)?$_REQUEST['action']:'';
	if($action == 'ajax'){
		...
		$reload = './instructores_desactivado.php';
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					<a href="#" class='btn btn-default' title='Activar instructor' onclick="activar('<?php echo $inst_id;?>');"><i class="glyphicon glyphicon-check"></i> </a></span>
          			</td>
