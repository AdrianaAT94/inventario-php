        ...
        $query_check_user=mysqli_num_rows($query_check_user_name);
          ...
          // write new user's data into database
                    ...
                    if ($query_new_user_insert) {
                        ...
                        $id_user=get_row('users','user_id', 'firstname', $firstname);
                        $user_id=$_SESSION['user_id'];
                        $nuser=$_SESSION['firstname']." ".$_SESSION['lastname'];
                        $hola = $firstname." ".$lastname;
                        $nota="$nuser agregó el usuario $hola a la aplicación";
                        echo guardar_historial_users($id_user,$user_id,$date_added,$nota);
                        envioMail_regis($user_email,$hola,$clave);
                    } else {
