<?php
  ...
  use Spipu\Html2Pdf\Exception\ExceptionFormatter;
    ...
    $sql="SELECT * FROM  categorias WHERE inactivo=1 order by nombre_categoria";
    $query = mysqli_query($con, $sql);

	$content = '<h2>CATEGORÍAS ELIMINADAS EN LA APLICACIÓN</h2>';
    ...
    $content .= '
      ...
      <th style="width: 100px; background-color: #A9D0F5; padding: 8px; line-height: 1.42857143; vertical-align: top; border-top: 1px solid #ddd;">Agregado</th>
        ...
        $pdf = "pdf/"."categorias-eliminadas-".date('dmYHis').".pdf";
