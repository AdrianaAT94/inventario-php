...
<html lang="en">
  ...
  <div class="panel panel-success">
    <div class="panel-heading">
        ...
        <button style="margin-right:20px;" type='button' class="btn btn-success" onclick="desactivado()">Categorías eliminadas</button>
        <?php } ?>
        ...
        <button type='button' class="btn btn-success" data-toggle="modal" data-target="#nuevaCategoria"><span class="glyphicon glyphicon-plus" ></span> Nueva Categoría</button>
      </div>
...
function desactivado (){
    window.location.href="categorias_desactivado.php";
  } 
function exportar_pdf (){
    window.open("ajax/pdf_categorias.php", "_blank");
  } 
</script>
