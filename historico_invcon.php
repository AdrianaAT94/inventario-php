<?php
  ...
  $active_elem_con="";
  $active_usuarios="";
  $title="Historico Inventario Convocatorias | Aerocamaras";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
	...
	include("footer.php");
	?>
	<script type="text/javascript" src="js/historico_invcon.js"></script>
...
function exportar_pdf (){
    window.open("ajax/pdf_historico_invcon.php", "_blank");
  } 
</script>